<?php
	...
	add_action('acf/init', 'hosparus_acf_init');
    ...
    add_action('wp_footer', 'medchatapp_script'); // adding MedChat
	...
	add_filter( 'gform_confirmation_anchor', '__return_true' ); // Scroll to gravity form after submission
